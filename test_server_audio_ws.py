...
class ServerAudioWsTests(unittest.TestCase):
    def _make_cfg(self, whisper_model: str = "small") -> ServerConfig:
        return ServerConfig(
            ...
            translation_source_languages_raw="es,de",
    ...
    def test_live_caption_passes_through_unsupported_language(self):
        ...
        self.assertIsNone(handler.caption_source_language(2))
    ...
    def test_low_confidence_english_does_not_block_later_german_translation(self):
        ...
        handler.responses = [
            ...
            _TranscriptionResult(text="good morning", language="en", language_probability=0.99),
        ]
        ...
        self.assertEqual(handler.caption_source_language(5), "de")
        self.assertEqual(
    ...
    def test_final_transcribe_uses_same_detect_then_translate_flow(self):
        handler = _StubHandler(self._make_cfg())
    ...
    def test_format_caption_prefixes_supported_language(self):
        self.assertEqual(
            AudioTranscriptionHandler.format_caption("How are you?", "de"),
            "(German) How are you?",
        )
        self.assertEqual(
            AudioTranscriptionHandler.format_caption("How are you?", None),
            "How are you?",
        )
